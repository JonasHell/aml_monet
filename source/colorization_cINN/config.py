...
validation_images = 'conditional_INNs/colorization_cINN/imagenet/validation_images.txt'
shuffle_val = False
...
img_folder = 'conditional_INNs/colorization_cINN/images'
silent = False
...
load_file = 'colorization_end_to_end_checkpoint_0160.pt'                      # load entire architecture (overwrites the prev. 2 options)
filename = 'colorization_end_to_end_checkpoint_0160.pt'   # output filename
